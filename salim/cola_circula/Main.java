...
public class Main {
    ...
    do {
      ...
      switch (op) {
        case 1:
          ...
          break;
        case 2:
          ClaseColaCircular.Eliminar();
          break;
        case 3:
          ClaseColaCircular.Mostrar();
          break;
      }
    } while (op != 0);
  }
  ...
  public static void Altas() throws IOException {
    ...
    dato = getInt();
    ClaseColaCircular.Insertar(dato); // Invocar el metodo Insertar del objeto ColaCircular
  }
